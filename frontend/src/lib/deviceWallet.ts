 ...
 *
 * This is what lets the "Pay with Goemon" button authorize a payment with the
...
const STORE = "goemon_device_wallet";

// ---- did:key P-256 encoder (port of the backend / goemon-agent didKey.ts) ----
