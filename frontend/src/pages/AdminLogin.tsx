...
const DEV_ACCOUNTS = [
  { role: "CEO", email: "ceo@argusfinancial.com", password: "Ceo1234!", path: "/admin/approvals" },
  { role: "Chief of Staff", email: "cos@argusfinancial.com", password: "Cos1234!", path: "/admin/approvals" },
  { role: "Admin", email: "admin@argusfinancial.com", password: "Admin1234!", path: "/admin" },
] as const;

export function AdminLogin() {
  const nav = useNavigate();
  const [email, setEmail] = useState("ceo@argusfinancial.com");
