/**
 * Goemon Pay — merchant wedge (Phase 21): register merchant, request payment, pay via escrow.
...
export function Pay() {
  ...
  /**
   * Pay with Goemon — login-less, via a Verifiable Credential.
   *
   ...
   */
  async function payWithGoemon(i: PaymentIntent) {
    setBusy(true);
    try {
      ...
      <div className="page stack lg narrow" style={{ maxWidth: 640 }}>
        ...
        <div className="card">
          <p className="muted small" style={{ margin: 0 }}>
            Merchant rail is disabled. Set <span className="code">GOEMON_PAY_ENABLED=true</span> for demo.
          </p>
        </div>
      </div>
    );
    ...
    <div className="page stack lg narrow" style={{ maxWidth: 640 }}>
      ...
      <div className="card stack sm">
        ...
        <p className="muted micro" style={{ margin: 0 }}>
          Or use <strong>Pay with Goemon</strong> on any unpaid intent below — your device credential
            ...
            {intents.map((i) => (
              <div key={i.id} className="list-row">
                ...
                {i.status === "held" ? (
                  ...
                  <button className="sm" disabled={busy} onClick={() => payWithGoemon(i)} title="Pay with your Verifiable Credential — no login">
                    Pay with Goemon
                  </button>
                ) : (
