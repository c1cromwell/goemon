...
const APPEND_ONLY_TABLES = ["audit_logs", "ledger_entries", "ledger_journals", "mcp_audit_logs", "fraud_decisions", "fills", "escrow_events", "payment_events", "reconciliation_runs", "reconciliation_findings", "account_holds", "transaction_flags", "agent_runs", "corporate_actions", "market_data_snapshots", "warehouse_export_runs"];
