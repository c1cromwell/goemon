...
export enum ErrorCode {
  ...
  PERSONHOOD_REQUIRED = "PERSONHOOD_REQUIRED",
  ...
  // Goemon Pay (Phase 21 Stage 1 rail)
  ...
  // Goemon Starter (Phase 22 — prototype kill-switch)
  TEEN_DISABLED = "TEEN_DISABLED",

  // Teen spend controls (Phase 22.1)
  SPEND_LIMIT_EXCEEDED = "SPEND_LIMIT_EXCEEDED",
  GUARDIAN_APPROVAL_REQUIRED = "GUARDIAN_APPROVAL_REQUIRED",

  TEEN_CREDIT_BUILDER_DISABLED = "TEEN_CREDIT_BUILDER_DISABLED",
  TEEN_CUSTODIAL_DISABLED = "TEEN_CUSTODIAL_DISABLED",
...
const DEFAULT_HTTP_STATUS: Record<ErrorCode, number> = {
  ...
  [ErrorCode.PERSONHOOD_REQUIRED]: 403,
