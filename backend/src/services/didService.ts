 ...
 *
 * DIDs:
 *   - Platform issuer: did:web:goemonglobal.com  (fragment #<kid> per key)
 *   - User subject:    did:web:goemonglobal.com:users:<userId>  (deterministic, no key needed)
