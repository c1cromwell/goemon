 ...
 *
 * DIDs:
 *   - Platform issuer: did:web:bankai.com  (fragment #<kid> per key)
 *   - User subject:    did:web:bankai.com:users:<userId>  (deterministic, no key needed)
