 ...
 *   issuer:               did:web:goemonglobal.com#<kid>
 *   credentialSubject.id: did:web:goemonglobal.com:users:<userId>
...
export async function issueCredential(
  ...
  return db.transaction(async (tx) => {
    ...
    const vcPayload = {
      ...
      type: ["VerifiableCredential", "GoemonKYCCredential"],
...
/** Fetch a credential by its subject DID (did:web:goemonglobal.com:users:<id>). */
