...
const TOOLS: ToolDef[] = [
  ...
  { name: "transfer_funds", description: "Transfer funds to another Goemon Global Finance user.", requiredScope: "transfer:low" },
  { name: "pay_merchant", description: "Pay a merchant's payment intent on the Goemon Pay rail (escrow-protected).", requiredScope: "pay:merchant" },
];
