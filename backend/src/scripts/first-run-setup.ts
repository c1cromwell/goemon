 ...
 *   2. seed the default RBAC admin (admin@goemonglobal.com / Admin1234!, role 'admin')
...
const SIMULATOR_AGENT = {
  ...
  displayName: "Goemon Global Finance Simulator Agent",
...
async function main(): Promise<void> {
  console.log("== Goemon Global Finance first-run setup ==");
