/**
 * Account linking — the one-time consent step. The user authenticates to Goemon Global Finance
    ...
    <div className="center">
      <div className="card narrow">
        <div className="brand" style={{ marginBottom: 16 }}>
          <span className="mark">A</span> Goemon Global Finance Assistant
          <span className="ext-tag">external agent</span>
        </div>
        <h1>Connect your Goemon Global Finance account</h1>
        ...
        <div className="stack" style={{ marginTop: 18 }}>
          <div>
            <label>Goemon Global Finance email</label>
