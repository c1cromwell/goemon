...
Bankai sits at the intersection of these three trends. The wedge is the tokenization marketplace. The retention is the wallet. The cost advantage is the agent-operated back office.

## Positioning statement

> **For** people who want their money to work harder than a checking account allows but who don't want to learn options trading or crypto, **Bankai** is a mobile-first bank that lets them hold dollars, own tokenized real-world assets and collectibles, and move money globally — all in one app, with no paperwork until they actually need it.
...
The working name is "Bankai." It draws from Japanese (the term means "release" or "final form"), which lends itself to a clean visual brand and is uncrowded in trademark databases. Final brand decision is open in Module 11.
