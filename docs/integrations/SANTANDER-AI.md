...
[Banco Santander AI Lab](https://github.com/SantanderAI) publishes Apache-2.0 tooling for responsible AI in financial services. None are banking products — they strengthen Argus **fraud graph ML** and **agent governance**.

## Adopted in this repo

| Upstream repo | Argus integration | Path |
|---|---|---|
...
- Code repos: Apache-2.0 — compatible with Argus prototype
