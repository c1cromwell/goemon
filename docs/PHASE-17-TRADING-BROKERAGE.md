...
and crypto spot — onto the Goemon Global Finance platform, **without letting the trading subsystem
...
> Read with: `docs/GOEMON-PLAN.md` Phase 17 (scope + corporate gate), `docs/business/CORPORATE-STRUCTURE.md`
