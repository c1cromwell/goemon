# Goemon Global Finance — Product Requirements Document
...
- Brand and product name confirmation — **resolved:** Goemon (DBA), Goemon Global Finance, LLC; domain goemonglobal.com (see Module 11 Q-BRAND-001)
