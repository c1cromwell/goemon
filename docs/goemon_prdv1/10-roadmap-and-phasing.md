...
- Register Goemon Global Finance entity per jurisdiction
...
- Bootstrap internal admin console (repurposed Goemon Global Finance CLI)
...
- Goemon Global Finance issues its own RWA tokens (specific assets TBD based on Phase 3 demand signals)
...
- **An NFT mint platform** — users can't mint arbitrary NFTs through Goemon Global Finance
- **A wallet for general crypto** — Goemon Global Finance is specifically a bank + marketplace, not a Trust Wallet competitor
