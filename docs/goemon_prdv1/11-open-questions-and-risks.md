...
|---|---|---|---|---|
| Q-ID-001 | Pseudonymous Goemon Global Finance handles (e.g., `@alice`) — supported in v1, and if so, are they network-discoverable or contact-list-only? | Product | Phase 1 | Open |
...
| ID | Question | Decision-maker | When needed by | Decision |
|---|---|---|---|---|
| Q-BRAND-001 | Final product name — is "Goemon" (DBA) / Goemon Global Finance the launch brand? Trademark and domain status | CEO + Legal + Design | Phase 0 | **Resolved (2026-06):** Goemon Global Finance, LLC · DBA **Goemon** · domain **goemonglobal.com** · repo **goemon**; trademark filing TBD with counsel |
...
| Goemon Global Finance CLI: repurposed as internal admin console | Founder | Preserves prior work as ops/compliance tooling |
...
| Q-BRAND-001 | **Goemon** (DBA) / Goemon Global Finance — launch brand | Founder | Rebrand R1 (2026-06); trademark TBD with counsel |
