...
This module describes the compliance framework Goemon Global Finance will operate under and the obligations it implies. It is not legal advice. Every requirement here will be reviewed and refined by external counsel before launch. Where this document and counsel disagree, counsel wins.

## US regulatory framework

Goemon Global Finance operates in the US under several overlapping regimes:

### Bank Secrecy Act (BSA) and AML

As a money services business (MSB) and (eventually) a custodian of customer funds, Goemon Global Finance is subject to BSA/AML requirements:
...
- **GENIUS Act (2025)** — provides federal framework for stablecoin issuers. Goemon Global Finance does not issue a stablecoin in v1; we use USDC issued by Circle (which is compliant). If we ever issue our own, we register under GENIUS.
...
- **Operating model:** partner with a CBN-licensed payment service provider (Flutterwave-tier) for fiat rails; operate the wallet and marketplace through a Goemon Global Finance Nigerian entity registered as a fintech
...
- **Smart contract audits** for any contracts Goemon Global Finance deploys (ERC-3643 implementations, escrow contracts, paymaster, multisig)
