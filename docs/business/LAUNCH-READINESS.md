...
A candid go/no-go on launching Argus in the US: where each gate actually stands, who owns it, and the
...
- **Door 2 — the full neobank** (deposits, cards, FX, Argus Pay, real trading/RWA). **Corp B/C**:
