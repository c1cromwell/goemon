...
Legal and product posture for **seller P2P slab listings** where Goemon holds buyer USDC in escrow until receipt is confirmed. This is **Tier 2** in the collectibles strategy: Goemon is the payment intermediary; the seller ships directly; no Courtyard/vault custody partner is required for the money path.
...
- **Not custody** — Goemon does not take possession of the physical slab in this lane (seller ships)
