/**
 * Account linking — the one-time consent step. The user authenticates to Goeman Global Finance
  ...
  return (
    <div className="center">
      <div className="card narrow">
        ...
        <h1>Connect your Goeman Global Finance account</h1>
        ...
        <div className="stack" style={{ marginTop: 18 }}>
          <div>
            <label>Goeman Global Finance email</label>
