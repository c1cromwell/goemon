/**
 * Service-to-service auth for the engine's /v1 surface. Goemon presents a shared
 * bearer (FRAUD_ENGINE_API_KEY); compared in constant time. This is not user
 * RBAC — the engine has no users, only a trusted caller (Goemon / the fraud team's
 * tooling).
 */
