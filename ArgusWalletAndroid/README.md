# Argus Wallet — Android (fast-follow)

Kotlin/Compose scaffold for PRD parity with the iOS wallet (`ArgusWallet/`). Phase A
...
1. Open `ArgusWalletAndroid/` in Android Studio (Giraffe+).
