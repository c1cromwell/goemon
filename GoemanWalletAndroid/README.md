# Goeman Wallet — Android (fast-follow)

Kotlin/Compose scaffold for PRD parity with the iOS wallet (`GoemanWallet/`). Phase A
...
1. Open `GoemanWalletAndroid/` in Android Studio (Giraffe+).
